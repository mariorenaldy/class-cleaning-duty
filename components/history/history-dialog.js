...
export default function HistoryDialog({dialogRef, students, historyData, setHistoryData}) {
    ...
    return (
        <dialog id="dialog-history-input" className="dialog-container" ref={dialogRef} onMouseDown={onMouseDown} onMouseUp={onMouseUp}>
            ...
            <div className="dialog-content content">
                <HistoryForm students={students} historyData={historyData} setHistoryData={setHistoryData} />
            </div>
        </dialog>
    )
}